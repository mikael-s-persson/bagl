...
template <typename T> struct numeric_values_floating_point {
    using value_type = T;
    static T zero() { return T{0.0}; }
    static T infinity() { return std::numeric_limits<T>::infinity(); }
};
template <> struct numeric_values<float> : numeric_values_floating_point<float> {};
template <> struct numeric_values<double> : numeric_values_floating_point<double> {};
template <> struct numeric_values<long double> : numeric_values_floating_point<long double> {};
