...
struct container_property_map : put_get_helper<container_property_map<Graph, Key, Container>> {
  ...
  container_property_map(Container& c, const Graph& g) : m_map(c.begin(), indexer_type::index_map(g)) {}
