...
template <BAGL_LINKED_TREE_ARGS>
auto& get_property(BAGL_LINKED_TREE& g, typename BAGL_LINKED_TREE::vertex_descriptor v) {
  return g.get_property(v);
}

// Returns a const-reference to the vertex-property associated to the given vertex descriptor.
template <BAGL_LINKED_TREE_ARGS>
const auto& get_property(const BAGL_LINKED_TREE& g, typename BAGL_LINKED_TREE::vertex_descriptor v) {
  return g.get_property(v);
}

// Returns a reference to the edge-property associated to the given edge descriptor.
template <BAGL_LINKED_TREE_ARGS>
auto& get_property(BAGL_LINKED_TREE& g, typename BAGL_LINKED_TREE::edge_descriptor e) {
  return g.get_property(e);
}

// Returns a const-reference to the edge-property associated to the given edge descriptor.
template <BAGL_LINKED_TREE_ARGS>
const auto& get_property(const BAGL_LINKED_TREE& g, typename BAGL_LINKED_TREE::edge_descriptor e) {
  return g.get_property(e);
}
