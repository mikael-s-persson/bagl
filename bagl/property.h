...
struct property {
  ...
  using tag_type = Tag;
  using value_type = T;
  explicit property(const T& v = T()) : m_value(v) {}
...
struct lookup_one_property_internal<property<Tag, T, Base>, Tag> {
  ...
  using type = T;
  template <typename U>
  static std::enable_if_t<std::is_same_v<prop, U>, T&> lookup(U& prop, const Tag& /*unused*/) {
    return prop.m_value;
  }
  template <typename U>
  static std::enable_if_t<std::is_same_v<prop, U>, const T&> lookup(const U& prop, const Tag& /*unused*/) {
    return prop.m_value;
  }
};
...
struct lookup_one_property_internal<property<Tag, T, Base>, PropName> : lookup_one_property_internal<Base, PropName> {
 ...
 public:
  ...
  static std::enable_if_t<std::is_same_v<PL, property<Tag, T, Base>>, typename base_type::type&>
...
struct lookup_one_property<const T, Tag> {
  ...
  static std::enable_if_t<std::is_same_v<T, U>,
                          const typename lookup_one_property_internal<T, Tag>::type&>
