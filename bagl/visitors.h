...
BAGL_GRAPH_HAS_MEMBER_FUNCTION(visit_vertex_pair)
...
BAGL_GRAPH_HAS_MEMBER_FUNCTION(begin_traversal)
BAGL_GRAPH_HAS_MEMBER_FUNCTION(begin_face)
BAGL_GRAPH_HAS_MEMBER_FUNCTION(next_edge)
BAGL_GRAPH_HAS_MEMBER_FUNCTION(next_vertex)
BAGL_GRAPH_HAS_MEMBER_FUNCTION(end_face)
BAGL_GRAPH_HAS_MEMBER_FUNCTION(end_traversal)
