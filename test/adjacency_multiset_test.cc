...
struct test_graphs {
  using MVL = adjacency_list<multiset_s, vec_s, Kind, VertexProp, EdgeProp, GraphProp>;
  using MLL = adjacency_list<multiset_s, list_s, Kind, VertexProp, EdgeProp, GraphProp>;
  using MPL = adjacency_list<multiset_s, pool_s, Kind, VertexProp, EdgeProp, GraphProp>;
