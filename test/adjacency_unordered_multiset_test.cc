...
struct test_graphs {
  ...
  using MVL = adjacency_list<unordered_multiset_s, vec_s, Kind, vprop, eprop>;
  using MLL = adjacency_list<unordered_multiset_s, list_s, Kind, vprop, eprop>;
  using MPL = adjacency_list<unordered_multiset_s, pool_s, Kind, vprop, eprop>;
