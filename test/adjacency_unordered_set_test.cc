...
struct test_graphs {
  using SVL = adjacency_list<unordered_set_s, vec_s, Kind, VertexProp, EdgeProp, GraphProp>;
  using SLL = adjacency_list<unordered_set_s, list_s, Kind, VertexProp, EdgeProp, GraphProp>;
  using SPL = adjacency_list<unordered_set_s, pool_s, Kind, VertexProp, EdgeProp, GraphProp>;

  using allgraphs = ::testing::Types<SVL, SLL, SPL>;
  using allgraphs_prop =
      ::testing::Types<std::tuple<SVL, PropMapMaps>, std::tuple<SLL, PropMapMaps>, std::tuple<SPL, PropMapMaps>>;
  using allgraphs_bund =
      ::testing::Types<std::tuple<SVL, BundleMaps>, std::tuple<SLL, BundleMaps>, std::tuple<SPL, BundleMaps>>;
};
