...
struct test_graphs {
  using LVL = linked_tree<multiset_s, vec_s, Kind, VertexProp, EdgeProp, GraphProp>;
  using LLL = linked_tree<multiset_s, list_s, Kind, VertexProp, EdgeProp, GraphProp>;
  using LPL = linked_tree<multiset_s, pool_s, Kind, VertexProp, EdgeProp, GraphProp>;
