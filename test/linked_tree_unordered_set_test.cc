...
struct test_graphs {
  using LVL = linked_tree<unordered_set_s, vec_s, Kind, VertexProp, EdgeProp, GraphProp>;
  using LLL = linked_tree<unordered_set_s, list_s, Kind, VertexProp, EdgeProp, GraphProp>;
  using LPL = linked_tree<unordered_set_s, pool_s, Kind, VertexProp, EdgeProp, GraphProp>;
