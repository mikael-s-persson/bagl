...
struct test_graphs {
  using SVL = adjacency_list<set_s, vec_s, Kind, VertexProp, EdgeProp, GraphProp>;
  using SLL = adjacency_list<set_s, list_s, Kind, VertexProp, EdgeProp, GraphProp>;
  using SPL = adjacency_list<set_s, pool_s, Kind, VertexProp, EdgeProp, GraphProp>;
