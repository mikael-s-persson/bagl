...
struct test_graphs {
  using LVL = linked_tree<vec_s, vec_s, Kind, VertexProp, EdgeProp, GraphProp>;
  using LLL = linked_tree<vec_s, list_s, Kind, VertexProp, EdgeProp, GraphProp>;
  using LPL = linked_tree<vec_s, pool_s, Kind, VertexProp, EdgeProp, GraphProp>;
